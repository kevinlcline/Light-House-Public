...
class Settings(BaseSettings):
    ...
    # Public internet gate: landing page + shared password (light-house.us).
    ...
    public_base_url: str | None = Field(
        ...
        description="Public site origin (e.g. https://light-house.us) used to build OAuth redirect if redirect URI unset.",
    )
